...
public class FaceToggleButtonTestActivity extends Activity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facetoggle);

        setTitle(R.string.face_toggle_title);
        ...
        fotb0.setOnStateChangeListener(new FaceOffToggleButton.OnStateChangeListener() {
            ...
            public void onStateChange(float process, State state, FaceOffToggleButton fotb) {
                ...
                if (state.equals(State.LEFT)) {
                    ...
                    lastToast = Toast.makeText(FaceToggleButtonTestActivity.this, "Left!", Toast.LENGTH_SHORT);
                    lastToast.show();
                }
                if (state.equals(State.RIGHT)) {
                    if (lastToast != null) lastToast.cancel();
                    lastToast = Toast.makeText(FaceToggleButtonTestActivity.this, "Right!", Toast.LENGTH_SHORT);
                    lastToast.show();
                }
            }
        });
